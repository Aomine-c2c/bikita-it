...
try {
  ...
  if (!html.includes('Pulse')) throw new Error('Expected product name was not rendered');
  ...
  if (fs.existsSync(indexPath)) {
    ...
    if (!html.includes('Pulse')) throw new Error('Expected product name was not rendered in static export');
