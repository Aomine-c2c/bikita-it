...
export function SoftwareAIOptimizer({ onSelectFilter }: SoftwareAIOptimizerProps) {
  return (
    <div data-tour="software-optimizer" className="relative overflow-hidden rounded-xl border border-indigo-500/30 bg-indigo-50/50 p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-indigo-500/10 rounded-xl p-4 flex flex-col justify-between hover:border-indigo-500/30 transition-colors">
          ...
          <button onClick={() => onSelectFilter?.("unassigned")} className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 mt-4 flex items-center gap-1 hover:gap-2 transition-all cursor-pointer">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-indigo-500/10 rounded-xl p-4 flex flex-col justify-between hover:border-indigo-500/30 transition-colors">
          ...
          <button onClick={() => onSelectFilter?.("duplicates")} className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 mt-4 flex items-center gap-1 hover:gap-2 transition-all cursor-pointer">
        ...
        <div className="bg-white/60 backdrop-blur-sm border border-indigo-500/10 rounded-xl p-4 flex flex-col justify-between hover:border-indigo-500/30 transition-colors">
          ...
          <button onClick={() => onSelectFilter?.("expiring")} className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 mt-4 flex items-center gap-1 hover:gap-2 transition-all cursor-pointer">
