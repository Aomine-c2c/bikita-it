...
import { Radar, RefreshCw, Network, Table, LayoutGrid } from "lucide-react";
import { useQuery } from "@tanstack/react-query";
import { networkApi } from "@/lib/api";

const NetworkTopology = dynamic(
  () => import("@/components/network/NetworkTopology").then((m) => m.NetworkTopology),
  { ssr: false, loading: () => <div className="h-[400px] animate-pulse bg-muted rounded-xl" /> }
);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span>Subnet Discovery Scan</span>
            </button>
          </div>
        </div>
